...
(function () {
  ...
  const BANNER_ID = ((window.Capacitor&&window.Capacitor.getPlatform&&window.Capacitor.getPlatform()==='android') ? 'ca-app-pub-7090581291853912/4853524973' : 'ca-app-pub-7090581291853912/3768762728');
  const INTER_ID  = ((window.Capacitor&&window.Capacitor.getPlatform&&window.Capacitor.getPlatform()==='android') ? 'ca-app-pub-7090581291853912/4663998884' : 'ca-app-pub-7090581291853912/5623599011');
